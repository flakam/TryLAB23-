...
namespace MVCLab23.Controllers
{
    public class ProductsController : Controller
    {
       ...
       [HttpGet]
        ...
        [HttpPost]
        public IActionResult Buy(string answer, string id)
        {
            ...
            if (answer == "yes")
            {
                ...
                Products p = _context.Products.FirstOrDefault(k=>k.Id==idt);
                if (p!=null)
                {
                    _product = p;
                }
                return RedirectToAction(nameof(IfBuy));
            }
            else 
            {
